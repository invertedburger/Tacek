...
STRINGS = {
    ...
    "prep.line1":         {"cs": "Dnešní menu se připravuje…", "en": "Today's menu is being prepared…"},
    "prep.line2":         {"cs": "Obvykle bývá hotové kolem 10:40. Níže zatím vidíte menu z minulého dne.",
                           "en": "Usually ready around 10:40. Below you can see the previous day's menu for now."},
